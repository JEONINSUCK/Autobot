...
import sys
try:
    from Lib_v1 import RSS_coindeskkorea, ArtiAnalysis
except ImportError:
    import RSS_coindeskkorea, ArtiAnalysis
...
class Crawler():
    ...
    def run(self):
        ...
        self.search_machine = RSS_coindeskkorea.SearchMachine(keyword=self.keyword, day=self.day, debug=self.debug)
